...
def solve():
    ...
    while True:
        try:
            ...
            for ind, bp in enumerate(blueprints[:3]):
                geode, orbot, cbot, obbot, gbot = geodes(bp, 1, 0, 0, 0, 0, 0, 0, 0, 32, max_ore[ind], max_clay[ind], max_obs[ind])
...
def geodes(bp, orbot, cbot, obbot, gbot, ore, clay, obs, geos, t, max_ore, max_clay, max_obs):
    ...
    if possible:
        ...
        return 0, orbot, cbot, obbot, gbot
